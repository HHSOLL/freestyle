...
Phase 8.5 admin fit-tooling starts at `docs/freestyle-viewer-platform/phase8_5/batch1.md`; keep that work read-only until a later batch explicitly introduces certification mutations.
...
- `Phase 8 / Batch 4` adds the admin-only `GET /v1/admin/fit-simulations/:id` inspection seam; keep it read-only and detail-by-id only
