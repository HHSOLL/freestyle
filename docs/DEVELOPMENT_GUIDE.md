...
Phase 8 HQ artifact identity starts at `docs/freestyle-viewer-platform/phase8/batch1.md`, the first owner-scoped lineage inspection seam is `docs/freestyle-viewer-platform/phase8/batch2.md`, and the first web consumer of that seam is `docs/freestyle-viewer-platform/phase8/batch3.md`. Keep those notes aligned with `docs/CLOTH_SIMULATE_JOB_DRAFT.md` and `docs/physical-fit-system.md` whenever the internal cache-key or artifact-lineage seam changes.
