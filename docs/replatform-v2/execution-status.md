...
| `Phase 2` B2C 기능 실체화 | `in_progress` | `looks -> decide -> journal` 중 `looks`부터 실체화 시작 |
...
- `Phase 2`: `/app/looks`를 informational shell에서 실제 saved looks surface로 전환
