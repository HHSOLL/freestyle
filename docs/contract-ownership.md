...
| Worker and job lifecycle contract | `workers/runtime/**`, `packages/queue/**`, `packages/db/**`, `workers/*`, `packages/contracts/**` | `docs/worker-playbook.md`, `docs/quality-gates.md`, `docs/CLOTH_SIMULATE_JOB_DRAFT.md` | Queue & Data Owner | API Contract Owner | job payloads, claim/retry rules, reserved job schemas, or persistence state transitions change |
