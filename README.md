...
- a Phase 10 hard gate through `npm run check:phase10`, which layers fit/visual/memory/context quality gates, asset-budget evidence, Phase 9 cutover/rollback smokes, and operational browser smoke on top of the full local gate
