...
| Body profile and avatar mapping | `packages/domain-avatar/**`, `packages/shared-types/**` | `docs/DEVELOPMENT_GUIDE.md`, `docs/architecture-overview.md` | Avatar Domain Owner | Runtime Owner | measurement mapping or persisted body profile shape changes |
