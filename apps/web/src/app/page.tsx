...
import { ImageOrbitBand } from '@/features/renewal-marketing/components/ImageOrbitBand';
      ...
      <section className="border-b border-black/8 px-5 pb-16 pt-8 sm:px-8 lg:px-12">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[minmax(0,0.86fr)_minmax(0,1.14fr)] lg:items-end">
          ...
          <motion.div
            ...
            className="relative mx-auto flex w-full max-w-[720px] items-center justify-center overflow-hidden"
          >
            <ImageOrbitBand images={images} />
          </motion.div>
        </div>
      </section>
