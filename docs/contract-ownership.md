...
| Avatar authoring sidecar contract | `packages/contracts/**`, `packages/contracts/src/__fixtures__/fit-calibration-report.json`, `packages/domain-avatar/src/calibration.ts`, `packages/runtime-3d/src/avatar-manifest.ts`, `packages/runtime-3d/src/avatar-publication-catalog.ts`, `apps/api/src/routes/runtime-avatars.routes.ts`, `apps/api/src/modules/avatars/runtime-avatars.service.ts`, `apps/api/src/modules/fit-simulations/fit-simulations.service.ts`, `scripts/validate-avatar-3d.mjs`, `scripts/validate-fit-calibration.mjs`, `output/avatar-certification/latest.json` | `docs/avatar-pipeline.md`, `docs/avatar-production-contract.md`, `docs/api-contract.md`, `docs/DEVELOPMENT_GUIDE.md`, `docs/physical-fit-system.md`, `docs/freestyle-viewer-platform/phase5/batch1.md`, `docs/freestyle-viewer-platform/phase5/batch2.md` | Avatar Domain Owner | API Contract Owner | measurements or sidecar schema, calibration artifact schema, avatar publication catalog shape, admin avatar read boundary, fit-simulation avatar-source behavior, parse rules, committed fixture shape, or calibration-side semantic checks change |
| Garment authoring summary contract | `packages/contracts/**`, `packages/domain-garment/**`, `scripts/validate-garment-3d.mjs`, `authoring/garments/mpfb/scripts/build_runtime_*.py`, `authoring/garments/mpfb/specs/*.pattern-spec.json`, `authoring/garments/exports/raw/*.summary.json`, `output/garment-certification/latest.json` | `docs/garment-fitting-contract.md`, `docs/physical-fit-system.md`, `docs/freestyle-improvement-status.md`, `docs/freestyle-viewer-platform/phase6/batch1.md` | Garment Contract Owner | Admin Publishing Owner | authoring summary schema/version, authoring pattern-spec shape, semantic parity helper behavior, certification bundle shape, provenance/path normalization, or pre-runtime validation rules change |
| Garment runtime contract | `packages/domain-garment/**`, `packages/contracts/**` | `docs/garment-fitting-contract.md`, `docs/admin-asset-publishing.md`, `docs/physical-fit-system.md` | Garment Contract Owner | Admin Publishing Owner | required runtime fields, size metadata, validation semantics, or derived instant-fit report behavior changes |
...
| Worker and job lifecycle contract | `workers/runtime/**`, `packages/queue/**`, `packages/db/**`, `workers/*`, `apps/api/src/modules/fit-simulations/**`, `packages/contracts/**` | `docs/worker-playbook.md`, `docs/quality-gates.md`, `docs/CLOTH_SIMULATE_JOB_DRAFT.md`, `docs/api-contract.md` | Queue & Data Owner | API Contract Owner | job payloads, claim/retry rules, active or reserved simulation schemas, or persistence state transitions change |
...
- avatar authoring sidecar contract: `docs/avatar-pipeline.md`, `docs/avatar-production-contract.md`, `docs/api-contract.md`, `docs/DEVELOPMENT_GUIDE.md`, `docs/physical-fit-system.md`, `docs/freestyle-viewer-platform/phase5/batch1.md`, `docs/freestyle-viewer-platform/phase5/batch2.md`
- garment runtime rules: `docs/garment-fitting-contract.md`, `docs/admin-asset-publishing.md`, and the active Phase 6 note when garment certification evidence changes
